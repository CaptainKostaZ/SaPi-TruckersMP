...
} else if(window.location.href.indexOf("truckersmp.com/user/") != -1) {
    // $('#sidebar-nav-1 > h2')
    //     .append($('<li/>', {"class": 'SaPiSteam list-group-item'})
    //     .append($('<a/>')
    //         .append($('<img/>', {"src": 'http://cdn.steamcommunity.com/public/images/login/throbber.gif', "width": '20'})
    //     )
    // ));
